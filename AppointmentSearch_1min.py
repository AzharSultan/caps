            ...
            while time.time()-start_time < 120:
                ...
                if "url(\'data:image" in contents:
                    ...
                    while 1:
                        ...
                        try:
                            try:
                                a = self.br.find_element_by_xpath("//a[contains(@href,'?locationCode=isla&realmId=108&categoryId=205&dateStr=%0.2d.05.2018')]"%(nowt+1))
                            except:
                                a = self.br.find_element_by_xpath("//a[contains(@href,'?locationCode=isla&realmId=108&categoryId=205&dateStr=%0.2d.05.2018')]"%(nowt+2))
                            a.click()
                            break
                        except:
                            continue
